/*
 * AUTOGENERATED CODE - jeudi 30 novembre 2017, 07:55:49 (UTC+0100)
 * DON'T EDIT BY HAND !
 */
...
static void jr_x(struct s_gb *s_gb)
{
	...
	if (FLAGS_ISZERO(s_gb->gb_register.f))
		...
		s_gb->gb_register.pc += 1; /* op code + size of address */
	/* ZERO unaffected */
	/* NEG unaffected */
	/* HALFC unaffected */
	/* CARRY unaffected */
...
static void ret_nz(struct s_gb *s_gb)
{
	...
	if (!FLAGS_ISZERO(s_gb->gb_register.f))
		...
		s_gb->gb_register.pc += 0; /* op code + size of address */
	/* ZERO unaffected */
	/* NEG unaffected */
	/* HALFC unaffected */
	/* CARRY unaffected */
...
static void jp_nz_xx(struct s_gb *s_gb)
{
	...
	if (!FLAGS_ISZERO(s_gb->gb_register.f))
		...
		s_gb->gb_register.pc += 2; /* op code + size of address */
	/* ZERO unaffected */
	/* NEG unaffected */
	/* HALFC unaffected */
	/* CARRY unaffected */
