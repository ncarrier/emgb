/*
 * AUTOGENERATED CODE - jeudi 23 novembre 2017, 18:33:58 (UTC+0100)
...
/* srl b [0x30] : The contents of b are shifted right one bit position. The contents of bit 0 are copied to the carry flag and a zero is put into bit 7. */
...
/* srl c [0x31] : The contents of c are shifted right one bit position. The contents of bit 0 are copied to the carry flag and a zero is put into bit 7. */
...
/* srl d [0x32] : The contents of d are shifted right one bit position. The contents of bit 0 are copied to the carry flag and a zero is put into bit 7. */
...
/* srl e [0x33] : The contents of e are shifted right one bit position. The contents of bit 0 are copied to the carry flag and a zero is put into bit 7. */
...
/* srl h [0x34] : The contents of h are shifted right one bit position. The contents of bit 0 are copied to the carry flag and a zero is put into bit 7. */
...
/* srl l [0x35] : The contents of l are shifted right one bit position. The contents of bit 0 are copied to the carry flag and a zero is put into bit 7. */
...
/* srl (hl) [0x36] : The contents of (hl) are shifted right one bit position. The contents of bit 0 are copied to the carry flag and a zero is put into bit 7. */
...
/* srl a [0x37] : The contents of a are shifted right one bit position. The contents of bit 0 are copied to the carry flag and a zero is put into bit 7. */
