/*
 * AUTOGENERATED CODE - dimanche 26 novembre 2017, 07:01:46 (UTC+0100)
...
static void exec_0xDD(struct s_gb *s_gb)
{
	/* start of exec_0xDD manual code */

	/* end of exec_0xDD manual code */
	/* ZERO unaffected */
	/* NEG unaffected */
	/* HALFC unaffected */
	/* CARRY unaffected */
...
static void exec_0xED(struct s_gb *s_gb)
{
	/* start of exec_0xED manual code */

	/* end of exec_0xED manual code */
	/* ZERO unaffected */
	/* NEG unaffected */
	/* HALFC unaffected */
	/* CARRY unaffected */
...
static void exec_0xFD(struct s_gb *s_gb)
{
	/* start of exec_0xFD manual code */

	/* end of exec_0xFD manual code */
	/* ZERO unaffected */
	/* NEG unaffected */
	/* HALFC unaffected */
	/* CARRY unaffected */
...
static void cb_sll_b(struct s_gb *s_gb)
{
	...
	/* sla opcodes are replaced with nibble swapping for gb */
	uint8_t value;
