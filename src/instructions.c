/*
 * AUTOGENERATED CODE - lundi 4 décembre 2017, 20:52:57 (UTC+0100)
 * DON'T EDIT BY HAND !
 */
...
static void jr_x(struct s_gb *s_gb)
{
	...
	if (FLAGS_ISZERO(s_gb->gb_register.f))
		s_gb->gb_register.pc = s_gb->gb_register.pc + (int8_t)read8bit(s_gb->gb_register.pc, s_gb) + 1;
	else
...
{
	s_gb->gb_register.bc = pop16(s_gb);
	/* ZERO unaffected */
	/* NEG unaffected */
	/* HALFC unaffected */
	/* CARRY unaffected */
...
{
	s_gb->gb_register.pc++;
	push16(read16bit(s_gb->gb_register.pc + 2, s_gb), s_gb);
	if (!FLAGS_ISZERO(s_gb->gb_register.f))
		s_gb->gb_register.pc = read16bit(s_gb->gb_register.pc, s_gb);
	else
		s_gb->gb_register.pc += 2; /* size of address */
...
{
	push16(s_gb->gb_register.bc, s_gb);
	/* ZERO unaffected */
	/* NEG unaffected */
	/* HALFC unaffected */
	/* CARRY unaffected */
...
static void exec_0xCB(struct s_gb *s_gb)
{
	...
	opcode = read8bit(s_gb->gb_register.pc, s_gb);
...
{
	push16(read16bit(s_gb->gb_register.pc + 3, s_gb), s_gb);
	s_gb->gb_register.pc = read16bit(s_gb->gb_register.pc + 1, s_gb);
	/* ZERO unaffected */
	/* NEG unaffected */
	/* HALFC unaffected */
	/* CARRY unaffected */
...
{
	s_gb->gb_register.de = pop16(s_gb);
	/* ZERO unaffected */
	/* NEG unaffected */
	/* HALFC unaffected */
	/* CARRY unaffected */
...
{
	push16(s_gb->gb_register.de, s_gb);
	/* ZERO unaffected */
	/* NEG unaffected */
	/* HALFC unaffected */
	/* CARRY unaffected */
...
{
	s_gb->gb_register.hl = pop16(s_gb);
	/* ZERO unaffected */
	/* NEG unaffected */
	/* HALFC unaffected */
	/* CARRY unaffected */
...
{
	push16(s_gb->gb_register.hl, s_gb);
	/* ZERO unaffected */
	/* NEG unaffected */
	/* HALFC unaffected */
	/* CARRY unaffected */
...
{
	s_gb->gb_register.af = pop16(s_gb);
	/* ZERO unaffected */
	/* NEG unaffected */
	/* HALFC unaffected */
	/* CARRY unaffected */
...
{
	push16(s_gb->gb_register.af, s_gb);
	/* ZERO unaffected */
	/* NEG unaffected */
	/* HALFC unaffected */
	/* CARRY unaffected */
