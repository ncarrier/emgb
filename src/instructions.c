/*
 * AUTOGENERATED CODE - mardi 28 novembre 2017, 06:22:26 (UTC+0100)
...
/* ldh (*),a [0xE0] : Put a into memory address $FF00 + n. */
static void ldh_px_a(struct s_gb *s_gb)
{
	/* start of ldh_px_a manual code */

	/* end of ldh_px_a manual code */
	/* ZERO unaffected */
	/* NEG unaffected */
	/* HALFC unaffected */
	/* CARRY unaffected */
...
static void ld_pc_a(struct s_gb *s_gb)
{
	...
	__typeof__(s_gb->gb_register.a) src_val = s_gb->gb_register.a;
	uint16_t dst_adr = s_gb->gb_register.c;
	write8bit(dst_adr, src_val, s_gb);
	/* ZERO unaffected */
	/* NEG unaffected */
	/* HALFC unaffected */
