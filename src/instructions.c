/*
 * AUTOGENERATED CODE - dimanche 26 novembre 2017, 07:40:45 (UTC+0100)
...
/* swap b [0x30] : The high and low nibbles of b are swapped. */
...
/* swap c [0x31] : The high and low nibbles of c are swapped. */
...
/* swap d [0x32] : The high and low nibbles of d are swapped. */
...
/* swap e [0x33] : The high and low nibbles of e are swapped. */
...
/* swap h [0x34] : The high and low nibbles of h are swapped. */
...
/* swap l [0x35] : The high and low nibbles of l are swapped. */
...
/* swap (hl) [0x36] : The high and low nibbles of (hl) are swapped. */
...
/* swap a [0x37] : The high and low nibbles of a are swapped. */
...
const struct s_cpu_z80 instructions_CB[] = {
	...
	[0x30] = {
		.opcode = 0x30,
		.value = "swap b",
		.doc = "The high and low nibbles of b are swapped.",
		.cycles = 8,
		.size = 2,
		.func = cb_swap_b,
	},
	[0x31] = {
		.opcode = 0x31,
		.value = "swap c",
		.doc = "The high and low nibbles of c are swapped.",
		.cycles = 8,
		.size = 2,
		.func = cb_swap_c,
	},
	[0x32] = {
		.opcode = 0x32,
		.value = "swap d",
		.doc = "The high and low nibbles of d are swapped.",
		.cycles = 8,
		.size = 2,
		.func = cb_swap_d,
	},
	[0x33] = {
		.opcode = 0x33,
		.value = "swap e",
		.doc = "The high and low nibbles of e are swapped.",
		.cycles = 8,
		.size = 2,
		.func = cb_swap_e,
	},
	[0x34] = {
		.opcode = 0x34,
		.value = "swap h",
		.doc = "The high and low nibbles of h are swapped.",
		.cycles = 8,
		.size = 2,
		.func = cb_swap_h,
	},
	[0x35] = {
		.opcode = 0x35,
		.value = "swap l",
		.doc = "The high and low nibbles of l are swapped.",
		.cycles = 8,
		.size = 2,
		.func = cb_swap_l,
	},
	[0x36] = {
		.opcode = 0x36,
		.value = "swap (hl)",
		.doc = "The high and low nibbles of (hl) are swapped.",
		.cycles = 15,
		.size = 2,
		.func = cb_swap_phl,
	},
	[0x37] = {
		.opcode = 0x37,
		.value = "swap a",
		.doc = "The high and low nibbles of a are swapped.",
		.cycles = 8,
		.size = 2,
		.func = cb_swap_a,
	},
